...
internal fun activityDescription(activity: Activity, shelfNames: Map<String, String> = emptyMap()): String {
    ...
    val action = when (activity.type) {
        ...
        ActivityType.VARIANT_CREATED -> "Dodana varijanta artikla"
        ActivityType.VARIANT_UPDATED -> "Uređena varijanta artikla"
        ActivityType.VARIANT_GROUPED -> "Varijanta pridružena artiklu"
        ActivityType.VARIANT_UNGROUPED -> "Varijanta izdvojena u novi artikl"
