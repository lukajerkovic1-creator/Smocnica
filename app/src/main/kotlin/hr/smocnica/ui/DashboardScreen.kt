...
internal fun activityDescription(activity: Activity, shelfNames: Map<String, String> = emptyMap()): String {
    ...
    val action = when (activity.type) {
        ...
        ActivityType.VARIANT_CREATED -> "Dodano pakiranje artikla"
        ActivityType.VARIANT_UPDATED -> "Uređeno pakiranje artikla"
        ActivityType.VARIANT_GROUPED -> "Pakiranje pridruženo artiklu"
        ActivityType.VARIANT_UNGROUPED -> "Pakiranje izdvojeno u novi artikl"
